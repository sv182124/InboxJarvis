...
description: "Set up the Telegram bot for InboxJarvis assistant chat."
---

This guide is for self-hosted deployments that want to enable Telegram chat with the InboxJarvis assistant.
...
Set your bot's webhook to InboxJarvis:
...
## 5. Connect a user account from InboxJarvis

Each InboxJarvis email account links to a Telegram user via a connect code:
