---
title: 'Contributing'
description: 'Set up InboxJarvis for local development'
---

This guide is for developers who want to run InboxJarvis locally and contribute to the project.
...
View open tasks in [GitHub Issues](https://github.com/sv182124/InboxJarvis/issues) to discuss what is being worked on.
