...
3. Paste the contents of the [`manifest.yaml` template](https://github.com/sv182124/InboxJarvis/blob/main/docs/slack/manifest.yaml), replacing `YOUR_DOMAIN` with your actual domain
4. Click **Create**
...
5. Invite the InboxJarvis bot to that private channel
