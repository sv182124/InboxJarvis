...
description: 'Choose the right AWS deployment method for InboxJarvis'
---

There are three ways to deploy InboxJarvis on AWS. Choose the one that fits your team and infrastructure.
