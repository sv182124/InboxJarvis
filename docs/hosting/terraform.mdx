...
description: 'Deploy InboxJarvis to AWS using Terraform'
---
...
Deploy InboxJarvis to AWS using Terraform. This provisions:
...
Run this command from the repository root after installing dependencies. You can also use `pnpm setup-terraform`.
