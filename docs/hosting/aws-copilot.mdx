...
description: 'Deploy InboxJarvis to AWS using AWS Copilot and ECS Fargate'
---
...
Deploy InboxJarvis to AWS using AWS Copilot. The deployment uses Amazon ECS on Fargate.
...
- InboxJarvis repository cloned locally (run all commands from the repo root)
