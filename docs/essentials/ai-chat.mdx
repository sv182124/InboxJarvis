...
AI Chat lets you search, understand, and manage your inbox in plain language. Open **Chat** in the left sidebar or visit [AI Chat](http://localhost:3000/assistant).
