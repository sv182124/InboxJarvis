...
Meeting Recorder adds **InboxJarvis Notetaker** to your video calls as a visible participant. After the call, InboxJarvis produces a transcript and summary with decisions, action items, and next steps. It can also email the notes to you and prepare a follow-up in your Drafts folder.
...
- Connect a Google or Microsoft calendar to InboxJarvis.
...
To permanently remove a meeting's summary and transcript from InboxJarvis, open the meeting, select the three-dot menu, and choose **Delete notes**. Recap emails already sent and follow-up drafts in your mailbox are separate copies and are not deleted.
