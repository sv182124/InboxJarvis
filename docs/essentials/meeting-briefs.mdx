...
Meeting Briefs means you walk into every external meeting prepared. Before a calendar event with external guests, InboxJarvis sends you a briefing that combines attendee details with your email and meeting history, plus web research.
...
The **Upcoming Meetings** section lists calendar events that InboxJarvis can see. Choose **Send test brief** to generate a sample immediately for a selected event.
