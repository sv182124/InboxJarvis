...
Open **Bulk Archive** under Cleanup in the left sidebar, or visit [Bulk Archive](http://localhost:3000/bulk-archive).

## How It Works

1. If sender categorization is not enabled yet, follow the setup prompt and let InboxJarvis categorize your sender history.
