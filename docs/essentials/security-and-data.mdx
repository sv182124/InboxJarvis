...
InboxJarvis needs access to your mailbox to search messages and run the workflows you enable. Optional features request additional access only when you connect them, such as calendar or drive permissions.

## Account permissions

- Email permissions allow InboxJarvis to read and organize messages and create drafts.
...
You can revoke a connection from InboxJarvis or from the provider's security settings. Revoking provider access stops the affected feature until you reconnect it.
...
Deleting your InboxJarvis account is separate from revoking Google or Microsoft access. See the [FAQ](/essentials/faq) for both processes and ask your deployment administrator about data handling and retention. This repository does not claim a hosted-service certification or privacy policy.
