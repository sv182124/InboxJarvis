...
- **Archive** removes the Gmail Inbox label and adds an InboxJarvis archive label.
- **Mark as Read** removes the unread state and adds an InboxJarvis processed label.
