---
title: 'Channels'
description: 'Connect Slack, Microsoft Teams, or Telegram and control what InboxJarvis delivers to chat.'
icon: 'messages'
---

The **Channels** page is the central place to connect chat apps and route InboxJarvis updates. You can receive rule notifications, draft replies, meeting briefs, follow-up reminders, digests, document-filing alerts, and scheduled check-ins.
...
3. Complete the provider-specific flow:
   - **Slack:** approve the Slack OAuth request and return to InboxJarvis.
   - **Teams or Telegram:** copy the generated `/connect` command and send it in a direct message to the InboxJarvis bot.
...
- **Teams**: Draft editing and sending are not available yet. Review or send the draft in InboxJarvis. Other quick actions are view-only.
...
You can direct-message the InboxJarvis bot in a connected provider. Slack also supports @mentions in channels where the bot is present. The assistant can use your connected email and calendar context.
...
Reconnect Slack if requested. Confirm that you still have access to the destination and that the InboxJarvis app is present in a private channel before selecting it.
