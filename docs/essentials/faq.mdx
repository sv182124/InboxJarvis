...
Answers to common questions about InboxJarvis.

### How do I add more email addresses to my account?

To connect another mailbox for yourself, open the account switcher at the top of the sidebar and choose **Add or manage accounts**. On the Accounts page, choose **Add Account** and connect the Gmail or Outlook mailbox. You can also open [Settings](http://localhost:3000/settings) and choose **Add Account** in the Email accounts section.

Each connected mailbox has its own assistant rules and settings. Use the account switcher to move between them.

To work with another person, create or join an organization instead. In Settings, use **Invite members** under Team. Organization membership and connecting another mailbox are separate actions.

### How do I organize my Gmail inbox with multiple sections?

You have two options for organizing emails by type in Gmail:

1. **Use the [optional upstream Tabs extension](/essentials/inbox-zero-tabs-extension)** if it supports your deployment. InboxJarvis does not publish this extension.
...
### Does InboxJarvis require a subscription?

This repository does not offer a hosted subscription. Your deployment may configure billing features; ask its administrator about any enabled billing portal. Third-party hosting and AI providers have their own charges.

### How do I delete my account?

Open the account menu at the bottom of the sidebar and choose [Settings](http://localhost:3000/settings). In the **Delete Account** section, click **Delete Account**.
...
- Search for the OAuth app name configured by your deployment, click on it, and then click **See Details**
...
- Find the OAuth app name configured by your deployment in the list and click on it
- Click **Remove** to revoke access

The provider may display a different name from InboxJarvis, depending on your OAuth app registration.
