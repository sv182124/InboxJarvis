...
<head>
  ...
  <title>Playwright · InboxJarvis</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">InboxJarvis · browser checks</p>
        <h1>Playwright</h1>
      ...
      <div class="actions">
        ...
        <a class="button" href="https://github.com/sv182124/InboxJarvis/actions/workflows/playwright.yml">GitHub Actions</a>
      </div>
    </header>
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="dark" />
  <title>Run screenshots · InboxJarvis</title>
  <style>
    ${SHARED_PAGE_STYLES}
...
<body>
  <main>
    <header>
      <div>
        <p class="eyebrow">InboxJarvis · visual review</p>
